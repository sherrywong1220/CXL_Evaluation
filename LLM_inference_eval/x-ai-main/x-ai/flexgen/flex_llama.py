...
# """]
    ...
    prompts = [
        """
Summarize the following story for me:
...
def run_flexgen(args):
    ...
    # llama_config = get_llama_config("huggyllama/llama-65b")
...
def add_parser_arguments(parser):
    parser.add_argument("--model", type=str, default="huggyllama/llama-30b",
        help="The model name.")
    parser.add_argument("--path", type=str, default="/mnt/nvme0n1-new-lv/data/llama_weights",
        help="The path to the model weights. If there are no cached weights, "
             "FlexGen will automatically download them from HuggingFace.")
    # try to figure out why offload-dir exist?

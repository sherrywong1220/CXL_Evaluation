...
class CostModelConfig:
    ...
    ctog_bdw: float = 18.364295959472656 * GB
    gtoc_bdw_cache: float = 0.9700000286102295 * GB
    gtoc_bdw_hidden: float = 3.7059247493743896 * GB

    dtoc_bdw: float = 9.185635566711426 * GB
    ctod_bdw_cache_p: float = 0.4802015423774719 * GB
    ctod_bdw_hidden_p: float = 1.2484183311462402 * GB
    ctod_bdw_g: float = 2.015000104904175 * GB

    mm_flops_p: float = 21.979633331298828 * T
    mm_flops_g: float = 4.300000190734863 * T
    bmm_flops_p: float = 10.592555046081543 * T

...
config_json="$script_dir/bert_large_config_no_pin.json"
bs=14
...
bert_options=" \
       ...
       --warmup .01 \
       --fp16 \
       &> bert_zero_2_numactl_DDR0_bs_${bs}_no_pin.log
"
...
bert_options=" \
       ...
       --warmup .01 \
       --fp16 \
        &> bert_zero_2_numactl_0,1_bs_${bs}_no_pin.log
 "
bert_options="${bert_options}
               --deepspeed \
               --deepspeed_config ${config_json} \
...
bert_options=" \
       ...
       --warmup .01 \
       --fp16 \
        &> bert_zero_2_numactl_0,2_bs_${bs}_no_pin.log
 "
bert_options="${bert_options}
               --deepspeed \
               --deepspeed_config ${config_json} \
...
bert_options=" \
       ...
       --warmup .01 \
       --fp16 \
        &> bert_zero_2_numactl_all_bs_${bs}_no_pin.log
 "
bert_options="${bert_options}
               --deepspeed \
               --deepspeed_config ${config_json} \

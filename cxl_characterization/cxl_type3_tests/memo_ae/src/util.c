...
void print_cfg(test_cfg_t* cfg) {
    ...
    fprintf (stderr, "==========================\n");
    fprintf (stderr, "num_thread:     %lu\n", cfg->num_thread);
    fprintf (stderr, "total_buf_size: %lu\n", cfg->total_buf_size);
    fprintf (stderr, "buf_a_numa_node:%d\n", cfg->buf_a_numa_node);
    fprintf (stderr, "buf_b_numa_node:%d\n", cfg->buf_b_numa_node);
    fprintf (stderr, "per_thread_size:%ld\n", cfg->per_thread_size);
    fprintf (stderr, "op_iter:        %d\n", cfg->op_iter);
    fprintf (stderr, "type:           %d\n", cfg->type);
    fprintf (stderr, "op:             %d\n", cfg->op);
    fprintf (stderr, "starting_core:  %d\n", cfg->starting_core);
    fprintf (stderr, "random:         %d\n", cfg->random);
    fprintf (stderr, "stall_ratio:    %d\n", cfg->stall_ratio);
    fprintf (stderr, "bw_granu:       %d\n", cfg->bw_granu);
    fprintf (stderr, "core_a:         %d\n", cfg->core_a);
    fprintf (stderr, "core_b:         %d\n", cfg->core_b);
    fprintf (stderr, "flush_block:    %d\n", cfg->flush_block);
    fprintf (stderr, "num_clear_pipe: %d\n", cfg->num_clear_pipe);
    fprintf (stderr, "tsc_freq (GHz): %f\n", cfg->tsc_freq);
    fprintf (stderr, "==========================\n");
}
